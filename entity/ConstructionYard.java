...
public class ConstructionYard extends SolidInfrastructure{
	...
	public void makePolygons(){
		...
		v = new vector[]{createArbitraryVertex(-0.38, 0.3, 0.35), createArbitraryVertex(-0.345, 0.3, 0.385), createArbitraryVertex(0.345, 0.3, 0.385), createArbitraryVertex(0.38, 0.3, 0.35), createArbitraryVertex(0.38, 0.3, -0.35),  createArbitraryVertex(0.345, 0.3, -0.385), createArbitraryVertex(-0.345, 0.3, -0.385), createArbitraryVertex(-0.38, 0.3, -0.35)};
		polyIndex = addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.38, 0.3, 0.385), createArbitraryVertex(0.38, 0.3, 0.385), createArbitraryVertex(-0.38, 0.3, -0.385), MainThread.textures[30], 1,1,1));
		polygons[polyIndex].shadowBias = 5000;
		
		v = new vector[]{createArbitraryVertex(0.345, 0.35, -0.1), createArbitraryVertex(0.345, 0.35, 0.345), createArbitraryVertex(0.345, 0.30, 0.345), createArbitraryVertex(0.345, 0.30, -0.1) };
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		
		v = new vector[]{createArbitraryVertex(-0.1, 0.30, -0.1), createArbitraryVertex(-0.1, 0.30, 0.345), createArbitraryVertex(-0.1, 0.35, 0.345),  createArbitraryVertex(-0.1, 0.35, -0.1)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		
		v = new vector[]{createArbitraryVertex(-0.0875, 0.35, -0.1), createArbitraryVertex(-0.0875, 0.35, 0.345), createArbitraryVertex(-0.0875, 0.30, 0.345), createArbitraryVertex(-0.0875, 0.30, -0.1) };
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		
		v = new vector[]{createArbitraryVertex(0.3325, 0.30, -0.1), createArbitraryVertex(0.3325, 0.30, 0.345), createArbitraryVertex(0.3325, 0.35, 0.345),  createArbitraryVertex(0.3325, 0.35, -0.1)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		
		v = new vector[]{createArbitraryVertex(0.3325, 0.35, -0.1), createArbitraryVertex(0.345, 0.35, -0.1), createArbitraryVertex(0.345, 0.30, -0.1), createArbitraryVertex(0.3325, 0.30, -0.1)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		
		v = new vector[]{createArbitraryVertex(0.3325, 0.30, 0.345), createArbitraryVertex(0.345, 0.30, 0.345), createArbitraryVertex(0.345, 0.35, 0.345), createArbitraryVertex(0.3325, 0.35, 0.345)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		
		v = new vector[]{createArbitraryVertex(-0.1, 0.35, -0.1), createArbitraryVertex(-0.0875, 0.35, -0.1), createArbitraryVertex(-0.0875, 0.30, -0.1), createArbitraryVertex(-0.1, 0.30, -0.1)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		
		v = new vector[]{createArbitraryVertex(-0.1, 0.30, 0.345), createArbitraryVertex(-0.0875, 0.30, 0.345), createArbitraryVertex(-0.0875, 0.35, 0.345), createArbitraryVertex(-0.1, 0.35, 0.345)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,0.25f,1));
		...
		for(int i = 0; i < 16; i++){
			v = new vector[]{createArbitraryVertex(r*Math.cos(i*delta) + w,  r*Math.sin(i*delta) +h, -0.1),
							 createArbitraryVertex(r*Math.cos((i+1)*delta) + w,   r*Math.sin((i+1)*delta) + h, -0.1),
						     createArbitraryVertex(r*Math.cos((i+1)*delta) + w, r*Math.sin((i+1)*delta) + h, 0.345),
							 createArbitraryVertex(r*Math.cos(i*delta) + w, r*Math.sin(i*delta) +h, 0.345)
							};
		    ...
		    changeVertex3DGeometry(w,h,-0.1f, tempVector);
		...
		double r2 = 0.21;
		for(int i = 0; i < 16; i++){
			v = new vector[]{createArbitraryVertex(r2*Math.cos(i*delta) + w, r2*Math.sin(i*delta) +h, 0.345),
							 createArbitraryVertex(r2*Math.cos((i+1)*delta) + w, r2*Math.sin((i+1)*delta) + h, 0.345),
							 createArbitraryVertex(r2*Math.cos((i+1)*delta) + w,   r2*Math.sin((i+1)*delta) + h, -0.1),
							 createArbitraryVertex(r2*Math.cos(i*delta) + w,  r2*Math.sin(i*delta) +h, -0.1)
							};
		...
		for(int i = 0; i < 16; i ++){
			v = new vector[]{createArbitraryVertex(r*Math.cos((i+1)*delta) + w,   r*Math.sin((i+1)*delta) + h, -0.1),
					         createArbitraryVertex(r*Math.cos(i*delta) + w,  r*Math.sin(i*delta) +h, -0.1),
					         createArbitraryVertex(r2*Math.cos(i*delta) + w,  r2*Math.sin(i*delta) +h, -0.1),
					         createArbitraryVertex(r2*Math.cos((i+1)*delta) + w,   r2*Math.sin((i+1)*delta) + h, -0.1)
					};
		...
		for(int i = 0; i < 16; i ++){
			v = new vector[]{createArbitraryVertex(r2*Math.cos((i+1)*delta) + w,   r2*Math.sin((i+1)*delta) + h, 0.345),
					         createArbitraryVertex(r2*Math.cos(i*delta) + w,  r2*Math.sin(i*delta) +h, 0.345),
					         createArbitraryVertex(r*Math.cos(i*delta) + w,  r*Math.sin(i*delta) +h, 0.345),
					         createArbitraryVertex(r*Math.cos((i+1)*delta) + w,   r*Math.sin((i+1)*delta) + h, 0.345)
					};
			addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		...
		for(int i = 0; i < 17; i++){
			v[i] = createArbitraryVertex(r*Math.cos(i*delta) + w, r*Math.sin(i*delta) +h, 0.33);
		}
		tempVector.set(v[0]);
		tempVector.y -=0.2;
		...
		v = new vector[]{createArbitraryVertex(0.3325, 0.35, 0.33), createArbitraryVertex(-0.0875, 0.35, 0.33), createArbitraryVertex(-0.0875, 0.30, 0.33), createArbitraryVertex(0.3325, 0.30, 0.33)};
		...
		v = new vector[17];
		for(int i = 0; i < 17; i++){
			v[16 - i] = createArbitraryVertex(r*Math.cos(i*delta) + w, r*Math.sin(i*delta) +h, -0.09);
		}
		tempVector.set(v[0]);
		tempVector.y -=0.2;
		...
		v = new vector[]{createArbitraryVertex(0.3325, 0.30, -0.09), createArbitraryVertex(-0.0875, 0.30, -0.09), createArbitraryVertex(-0.0875, 0.35, -0.09), createArbitraryVertex(0.3325, 0.35, -0.09)};
		...
		v = new vector[]{createArbitraryVertex(w - 0.11, 0.48, -0.091), createArbitraryVertex(w + 0.11, 0.48, -0.091), createArbitraryVertex(w + 0.11, 0.3, -0.091), createArbitraryVertex(w - 0.11, 0.3, -0.091)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[52], 1,0.8f,1));
		
		v = new vector[]{createArbitraryVertex(w - 0.11, 0.49, -0.092), createArbitraryVertex(w + 0.11, 0.49, -0.092), createArbitraryVertex(w + 0.11, 0.47, -0.092), createArbitraryVertex(w - 0.11, 0.47, -0.092)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 3,0.5f,1));
		
		
		v = new vector[]{createArbitraryVertex(-0.32, 0.41, 0.31), createArbitraryVertex(-0.08, 0.41, 0.31), createArbitraryVertex(-0.08, 0.41, -0.06), createArbitraryVertex(-0.32, 0.41, -0.06)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.32, 0.41, 0.31), createArbitraryVertex(-0.32, 0.41, -0.06), createArbitraryVertex(-0.33, 0.405, -0.07), createArbitraryVertex(-0.33, 0.405, 0.32)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		
		
		v = new vector[]{createArbitraryVertex(-0.33, 0.405, -0.07), createArbitraryVertex(-0.32, 0.41, -0.06),  createArbitraryVertex(-0.08, 0.41, -0.06), createArbitraryVertex(-0.06, 0.405, -0.07)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		
		
		v = new vector[]{createArbitraryVertex(-0.32, 0.41, 0.31), createArbitraryVertex(-0.33, 0.405, 0.32), createArbitraryVertex(-0.06, 0.405, 0.32), createArbitraryVertex(-0.08, 0.41, 0.31)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		
		
		v = new vector[]{createArbitraryVertex(-0.06, 0.405, 0.32), createArbitraryVertex(-0.33, 0.405, 0.32), createArbitraryVertex(-0.33, 0.3, 0.32), createArbitraryVertex(-0.06, 0.3, 0.32) };
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		
		
		v = new vector[]{createArbitraryVertex(-0.06, 0.3, -0.07), createArbitraryVertex(-0.33, 0.3, -0.07), createArbitraryVertex(-0.33, 0.405, -0.07) , createArbitraryVertex(-0.06, 0.405, -0.07)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
	
		
		v = new vector[]{createArbitraryVertex(-0.33, 0.405, 0.32), createArbitraryVertex(-0.33, 0.405, -0.07), createArbitraryVertex(-0.33, 0.3, -0.07), createArbitraryVertex(-0.33, 0.3, 0.32)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		...
		for(int i = 0; i < 18; i++){
			v = new vector[]{createArbitraryVertex(r*Math.cos((i+1)*theta + angleOffset), 0.04,  r*Math.sin((i+1)*theta + angleOffset)),
					 createArbitraryVertex(r*Math.cos(i*theta + angleOffset), 0.04, r*Math.sin(i*theta + angleOffset)),
					 createArbitraryVertex(r*Math.cos(i*theta + angleOffset), 0.09, r*Math.sin(i*theta + angleOffset)),
					 createArbitraryVertex(r*Math.cos((i+1)*theta + angleOffset), 0.09, r*Math.sin((i+1)*theta + angleOffset))
							};
		...
		v = new vector[21];
		for(int i = 0; i < 19; i++){
			v[i] = createArbitraryVertex(r*Math.cos((18-i)*theta + angleOffset), 0.09, r*Math.sin((18-i)*theta + angleOffset));
		}
		...
		for(int i = 0; i < 16; i++){
			v = new vector[]{ createArbitraryVertex(0.005f, r*Math.cos((i+1)*theta + angleOffset) + h,  r*Math.sin((i+1)*theta + angleOffset) + l),
					 createArbitraryVertex( 0.005f, r*Math.cos(i*theta + angleOffset) + h, r*Math.sin(i*theta + angleOffset) + l),
					 createArbitraryVertex( -0.005, r*Math.cos(i*theta + angleOffset) + h, r*Math.sin(i*theta + angleOffset) + l),
					 createArbitraryVertex(-0.005f, r*Math.cos((i+1)*theta + angleOffset) + h, r*Math.sin((i+1)*theta + angleOffset) + l)
							};
		...
		v = new vector[19];
		for(int i = 0; i < 17; i ++){
			v[i] = createArbitraryVertex(-0.005f, r*Math.cos((16-i)*theta + angleOffset)+h, r*Math.sin((16-i)*theta + angleOffset)+l);
		}
		...
		v = new vector[]{createArbitraryVertex(-0.02f,0.025f, 0.23), createArbitraryVertex(0.02f,0.025f, 0.23), createArbitraryVertex(0.02f,0.025f, -0.02),  createArbitraryVertex(-0.02f,0.025f, -0.02)};
		...
		v = new vector[]{ createArbitraryVertex(-0.02f,-0.015f, -0.02), createArbitraryVertex(0.02f,-0.015f, -0.02), createArbitraryVertex(0.02f,-0.015f, 0.23), createArbitraryVertex(-0.02f,-0.015f, 0.23)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[upperBodyTExture], 10,10,1));
		polygons[polyIndex].shadowBias = 100000;
		
		v = new vector[]{createArbitraryVertex(0.02f,0.025f, -0.02), createArbitraryVertex(0.02f,0.025f, 0.23), createArbitraryVertex(0.02f,-0.015f, 0.23), createArbitraryVertex(0.02f,-0.015f, -0.02)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[upperBodyTExture], 10,10,1));
		polygons[polyIndex].shadowBias = 100000;
		
		v = new vector[]{createArbitraryVertex(-0.02f,-0.015f, -0.02), createArbitraryVertex(-0.02f,-0.015f, 0.23), createArbitraryVertex(-0.02f,0.025f, 0.23), createArbitraryVertex(-0.02f,0.025f, -0.02)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[upperBodyTExture], 10,10,1));
		polygons[polyIndex].shadowBias = 100000;
		...
		for(int i = 0; i < 16; i++){
			v = new vector[]{ createArbitraryVertex(0.02f, r*Math.cos((i+1)*theta + angleOffset) + h,  r*Math.sin((i+1)*theta + angleOffset) + l),
					 createArbitraryVertex( 0.02f, r*Math.cos(i*theta + angleOffset) + h, r*Math.sin(i*theta + angleOffset) + l),
					 createArbitraryVertex(-0.02f, r*Math.cos(i*theta + angleOffset) + h, r*Math.sin(i*theta + angleOffset) + l),
					 createArbitraryVertex(-0.02f, r*Math.cos((i+1)*theta + angleOffset) + h, r*Math.sin((i+1)*theta + angleOffset) + l)
							};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[upperBodyTExture], 10,10,1));
		}
		...
		v = new vector[17];
		for(int i = 0; i < 17; i ++){
			v[i] = createArbitraryVertex(-0.02f, r*Math.cos((16-i)*theta + angleOffset)+h, r*Math.sin((16-i)*theta + angleOffset)+l);
		}
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[upperBodyTExture], 10,10,1));
		...
		v = new vector[]{createArbitraryVertex(0.02f,0.025f, 0.23), createArbitraryVertex(-0.02f,0.025f, 0.23), createArbitraryVertex(-0.02f,-0.015f, 0.23), createArbitraryVertex(0.02f,-0.015f, 0.23)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[upperBodyTExture], 10,10,1));
		
		v = new vector[]{createArbitraryVertex(-0.015f,0.02f, 0.27), createArbitraryVertex(0.015f,0.02f, 0.27), createArbitraryVertex(0.015f,0.02f, 0.03),  createArbitraryVertex(-0.015f,0.02f, 0.03)};
		polyIndex = addPolygon(polygons,  new polygon3D(v, v[0], v[1], v[3], MainThread.textures[47], 10,10,1));
		
		v = new vector[]{ createArbitraryVertex(-0.015f,-0.01f, 0.03), createArbitraryVertex(0.015f,-0.01f, 0.03), createArbitraryVertex(0.015f,-0.01f, 0.27), createArbitraryVertex(-0.015f,-0.01f, 0.27)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[47], 10,10,1));
	
		v = new vector[]{createArbitraryVertex(0.015f,0.02f, 0.03), createArbitraryVertex(0.015f,0.02f, 0.27), createArbitraryVertex(0.015f,-0.01f, 0.27), createArbitraryVertex(0.015f,-0.01f, 0.03)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[47], 10,10,1));
		
		v = new vector[]{createArbitraryVertex(-0.015f,-0.01f, 0.03), createArbitraryVertex(-0.015f,-0.01f, 0.27), createArbitraryVertex(-0.015f,0.02f, 0.27), createArbitraryVertex(-0.015f,0.02f, 0.03)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[47], 10,10,1));
	
		
		v = new vector[]{createArbitraryVertex(-0.02f,0.025f, 0.29), createArbitraryVertex(0.02f,0.025f, 0.29), createArbitraryVertex(0.02f,0.025f, 0.27),  createArbitraryVertex(-0.02f,0.025f, 0.27)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[armTop], 1.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.02f,0.025f, 0.27), createArbitraryVertex(0.02f,0.025f, 0.29), createArbitraryVertex(0.02f,0f, 0.29), createArbitraryVertex(0.02f,-0.015f, 0.27)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[armTop], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.02f,-0.015f, 0.27), createArbitraryVertex(-0.02f,0f, 0.29), createArbitraryVertex(-0.02f,0.025f, 0.29), createArbitraryVertex(-0.02f,0.025f, 0.27)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[armTop], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.02f,0.025f, 0.29), createArbitraryVertex(-0.02f,0.025f, 0.29), createArbitraryVertex(-0.02f,0, 0.29), createArbitraryVertex(0.02f,0, 0.29)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[armTop], 1.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.02f,0.025f, 0.27), createArbitraryVertex(0.02f,0.025f, 0.27), createArbitraryVertex(0.02f,-0.015f, 0.27), createArbitraryVertex(-0.02f,-0.015f, 0.27)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[armTop], 1.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.02f,0, 0.29), createArbitraryVertex(-0.02f,0, 0.29), createArbitraryVertex(-0.02f,-0.015f, 0.27), createArbitraryVertex(0.02f,-0.015f, 0.27)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[armTop], 1.2f,1f,1));
		...
		for(int i = 0; i < 24; i++){
			v = new vector[]{createArbitraryVertex(r*Math.cos((i+1)*theta) ,  r*Math.sin((i+1)*theta), 0.08),
							createArbitraryVertex(r*Math.cos(i*theta) , r*Math.sin(i*theta), 0.08),
							createArbitraryVertex(r*Math.cos(i*theta) , r*Math.sin(i*theta), 0 ),
					 		createArbitraryVertex(r*Math.cos((i+1)*theta), r*Math.sin((i+1)*theta), 0),
		...
		v = new vector[24];
		for(int i = 0; i < 24; i ++){
			v[i] = createArbitraryVertex(r*Math.cos(i*theta), r*Math.sin(i*theta), 0.08);
		}
		polyIndex = addPolygon(polygons,  new polygon3D(v, v[0], v[1], v[3], MainThread.textures[upperBodyTExture], 4f,4f,1));
		
		r = 0.005;
		for(int i = 0; i < 24; i++){
			v = new vector[]{createArbitraryVertex(r*Math.cos((i+1)*theta),  r*Math.sin((i+1)*theta), 0.18),
							createArbitraryVertex(r*Math.cos(i*theta), r*Math.sin(i*theta), 0.18),
							createArbitraryVertex(r*Math.cos(i*theta), r*Math.sin(i*theta), 0.08 ),
					 		createArbitraryVertex(r*Math.cos((i+1)*theta), r*Math.sin((i+1)*theta), 0.08),
		...
		v = new vector[32];
		for(int i = 0; i < 32; i++){
			v[31 - i] = createArbitraryVertex(r*Math.cos(i*delta), 0.411,  r*Math.sin(i*delta));
		}
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], null, 1,1f,4));
		
		v = new vector[32];
		for(int i = 0; i < 32; i++){
			v[31 - i] = createArbitraryVertex(r*Math.cos(i*delta), 0.341,  r*Math.sin(i*delta));
		}
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3],  MainThread.textures[51], 1,1f,1));
		
		
		for(int i = 0; i < 32; i++){
			v = new vector[]{createArbitraryVertex(r*Math.cos(i*delta), 0.311,  r*Math.sin(i*delta)),
					createArbitraryVertex(r*Math.cos((i +1)*delta), 0.311,  r*Math.sin((i + 1)*delta)),
					createArbitraryVertex(r*Math.cos((i +1)*delta), 0.411,  r*Math.sin((i + 1)*delta)),
					createArbitraryVertex(r*Math.cos(i*delta), 0.411,  r*Math.sin(i*delta))
							};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		}
		...
		r2 = 0.0001f;
		for(int i = 0; i < 32; i++){
			v = new vector[]{createArbitraryVertex(r2*Math.cos(i*delta), 0.4,  r2*Math.sin(i*delta)),
					createArbitraryVertex(r2*Math.cos((i +1)*delta), 0.4,  r2*Math.sin((i + 1)*delta)),
		...
		h = 0.38f;
			...
			v = new vector[5];
			for(int i = 0; i < 4; i++){
				v[3 - i] = createArbitraryVertex(r*Math.cos(i*delta), h,  r*Math.sin(i*delta));
			}
			v[4] = createArbitraryVertex(0,h,0);
			addPolygon(vent1, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[25], 1,1f,1));
			vent1[0].shadowBias = 40000;
			
			v = new vector[5];
			for(int i = 0; i < 4; i++){
				v[3 - i] = createArbitraryVertex(r*Math.cos((i+10)*delta), h,  r*Math.sin((i+10)*delta));
			}
			v[4] = createArbitraryVertex(0,h,0);
			addPolygon(vent1, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[25], 1,1f,1));
			...
			v = new vector[5];
			for(int i = 0; i < 4; i++){
				v[3 - i] = createArbitraryVertex(r*Math.cos((i+20)*delta), h,  r*Math.sin((i+20)*delta));
			}
			v[4] = createArbitraryVertex(0,h,0);
			addPolygon(vent1, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[25], 1,1f,1));
		...
		v = new vector[]{createArbitraryVertex(-0.08, -0.26, 0.08), createArbitraryVertex(0.08, -0.26, 0.08), createArbitraryVertex(0.08, -0.26, -0.08), createArbitraryVertex(-0.08, -0.26, -0.08)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.08, -0.26, -0.08),  createArbitraryVertex(0.08, -0.26, -0.08),  createArbitraryVertex(0.13, -0.35, -0.13), createArbitraryVertex(-0.13, -0.35, -0.13)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.13, -0.35, 0.13),  createArbitraryVertex(0.13, -0.35, 0.13),  createArbitraryVertex(0.08, -0.26, 0.08), createArbitraryVertex(-0.08, -0.26, 0.08)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[51], 1,1f,1));
		...
		v = new vector[]{createArbitraryVertex(0.23, -0.3095, 0.12), createArbitraryVertex(0.31, -0.3095, 0.12), createArbitraryVertex(0.31, -0.3095, 0.11), createArbitraryVertex(0.23, -0.3095, 0.11)};
		...
		v = new vector[]{createArbitraryVertex(0.37, -0.3095, 0.12), createArbitraryVertex(0.45, -0.3095, 0.12), createArbitraryVertex(0.45, -0.3095, 0.11), createArbitraryVertex(0.37, -0.3095, 0.11)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 1,1f,1));
		polygons[polyIndex].diffuse_I-=20;
		
		v = new vector[]{createArbitraryVertex(0.23, -0.3095, -0.09), createArbitraryVertex(0.31, -0.3095, -0.09), createArbitraryVertex(0.31, -0.3095, -0.1), createArbitraryVertex(0.23, -0.3095, -0.1)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 1,1f,1));
		polygons[polyIndex].diffuse_I-=20;
		
		v = new vector[]{createArbitraryVertex(0.37, -0.3095, -0.09), createArbitraryVertex(0.45, -0.3095, -0.09), createArbitraryVertex(0.45, -0.3095, -0.1), createArbitraryVertex(0.37, -0.3095, -0.1)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 1,1f,1));
		polygons[polyIndex].diffuse_I-=20;
		
		v = new vector[]{createArbitraryVertex(0.23, -0.3095, 0.12), createArbitraryVertex(0.24, -0.3095, 0.12), createArbitraryVertex(0.24, -0.3095, 0.04), createArbitraryVertex(0.23, -0.3095, 0.04)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 1,1f,1));
		polygons[polyIndex].diffuse_I-=20;
		
		v = new vector[]{createArbitraryVertex(0.23, -0.3095, -0.02), createArbitraryVertex(0.24, -0.3095, -0.02), createArbitraryVertex(0.24, -0.3095,-0.1), createArbitraryVertex(0.23, -0.3095, -0.1)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 1,1f,1));
		polygons[polyIndex].diffuse_I-=20;
		
		v = new vector[]{createArbitraryVertex(0.44, -0.3095, 0.12), createArbitraryVertex(0.45, -0.3095, 0.12), createArbitraryVertex(0.45, -0.3095, 0.04), createArbitraryVertex(0.44, -0.3095, 0.04)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 1,1f,1));
		polygons[polyIndex].diffuse_I-=20;
		
		v = new vector[]{createArbitraryVertex(0.44, -0.3095, -0.02), createArbitraryVertex(0.45, -0.3095, -0.02), createArbitraryVertex(0.45, -0.3095,-0.1), createArbitraryVertex(0.44, -0.3095, -0.1)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[doorTextureIndex], 1,1f,1));
		polygons[polyIndex].diffuse_I-=20;
		...
		v = new vector[]{createArbitraryVertex(-0.345, 0.3, -0.385), createArbitraryVertex(0.345, 0.3, -0.385), createArbitraryVertex(0.345, 0.28, -0.385), createArbitraryVertex(-0.345, 0.28, -0.385)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[30], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.345, 0.28,0.385), createArbitraryVertex(0.345, 0.28, 0.385), createArbitraryVertex(0.345, 0.3, 0.385), createArbitraryVertex(-0.345, 0.3, 0.385)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[30], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.38, 0.3, 0.35), createArbitraryVertex(-0.38, 0.3, -0.35),  createArbitraryVertex(-0.38, 0.28, -0.35), createArbitraryVertex(-0.38, 0.28, 0.35)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[30], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.38, 0.28, 0.35),  createArbitraryVertex(0.38, 0.28, -0.35), createArbitraryVertex(0.38, 0.3, -0.35), createArbitraryVertex(0.38, 0.3, 0.35)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[30], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.345, 0.3, 0.385), createArbitraryVertex(-0.38, 0.3, 0.35), createArbitraryVertex(-0.38, 0.28, 0.35), createArbitraryVertex(-0.345, 0.28, 0.385)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[30], 1,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.345, 0.28, 0.385), createArbitraryVertex(0.38, 0.28, 0.35), createArbitraryVertex(0.38, 0.3, 0.35), createArbitraryVertex(0.345, 0.3, 0.385)};
		addPolygon(polygons, new polygon3D(v, v[0], v[1], v[3], MainThread.textures[30], 1,1f,1));
	...
	public void cancelBuilding(){
		...
		missileTurretProgress = 255;
		if(teamNo == 0)
			MainThread.playerCommander.theBaseInfo.currentCredit+=creditSpentOnBuilding;
		else
			MainThread.enemyCommander.theBaseInfo.currentCredit+=creditSpentOnBuilding;
		creditSpentOnBuilding = 0;
	...
	public void createBuilding(){
		if(powerPlantProgress == 240){
			...
			int y = 127 - dg.gridOneIndex/128;
			int x = dg.gridOneIndex%128 + 1;
			GunTurrent o = new GunTurrent(x*0.25f -0.125f, -0.65f, y*0.25f + 0.125f, 0);
