...
public class Refinery extends SolidObject {
	...
	public void makePolygons(){
		...
		for(int i = 0; i < cargos.length; i++){
			...
			v = new vector[]{createArbitraryVertex(referenceX, referenceY,  0.1), createArbitraryVertex(referenceX+0.07, referenceY,  0.1), createArbitraryVertex(referenceX+0.06, referenceY-0.05,  0.1), createArbitraryVertex(referenceX+0.01, referenceY-0.05,  0.1)};
			...
			v = new vector[]{createArbitraryVertex(referenceX, referenceY,  0.175), createArbitraryVertex(referenceX+0.07, referenceY,  0.175), createArbitraryVertex(referenceX+0.06, referenceY-0.05,  0.175), createArbitraryVertex(referenceX+0.01, referenceY-0.05,  0.175)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,1f,1));
			cargos[i][1] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX+0.01, referenceY-0.05,  0.18), createArbitraryVertex(referenceX+0.06, referenceY-0.05,  0.18), createArbitraryVertex(referenceX+0.07, referenceY,  0.18), createArbitraryVertex(referenceX, referenceY,  0.18)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,1f,1));
			cargos[i][2] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX+0.01, referenceY-0.05,  0.105), createArbitraryVertex(referenceX+0.06, referenceY-0.05,  0.105), createArbitraryVertex(referenceX+0.07, referenceY,  0.105), createArbitraryVertex(referenceX, referenceY,  0.105)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,1f,1));
			cargos[i][3] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX+0.07, referenceY,  0.1), createArbitraryVertex(referenceX+0.07, referenceY,  0.18), createArbitraryVertex(referenceX+0.06, referenceY-0.05,  0.18), createArbitraryVertex(referenceX+0.06, referenceY -0.05,  0.1)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,1f,1));
			cargos[i][4] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX+0.055, referenceY-0.05,  0.1), createArbitraryVertex(referenceX+0.055, referenceY-0.05,  0.18), createArbitraryVertex(referenceX+0.065, referenceY,  0.18), createArbitraryVertex(referenceX+0.065, referenceY,  0.1)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,1f,1));
			cargos[i][5] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX, referenceY,  0.18), createArbitraryVertex(referenceX, referenceY,  0.1), createArbitraryVertex(referenceX+0.01, referenceY-0.05,  0.1), createArbitraryVertex(referenceX+0.01, referenceY-0.05,  0.18)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,1f,1));
			cargos[i][6] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX+0.015, referenceY- 0.05,  0.18), createArbitraryVertex(referenceX+0.015, referenceY-0.05,  0.1), createArbitraryVertex(referenceX+0.005, referenceY,  0.1), createArbitraryVertex(referenceX+0.005, referenceY,  0.18)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,1f,1));
			cargos[i][7] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX, referenceY,  0.105), createArbitraryVertex(referenceX+0.07, referenceY,  0.105), createArbitraryVertex(referenceX+0.07, referenceY,  0.1), createArbitraryVertex(referenceX, referenceY,  0.1)};
			...
			v = new vector[]{createArbitraryVertex(referenceX, referenceY,  0.18), createArbitraryVertex(referenceX+0.07, referenceY,  0.18), createArbitraryVertex(referenceX+0.07, referenceY,  0.175), createArbitraryVertex(referenceX, referenceY,  0.175)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1,0.2f,1));
			cargos[i][9] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX, referenceY,  0.18), createArbitraryVertex(referenceX+0.005, referenceY,  0.18), createArbitraryVertex(referenceX+0.005, referenceY,  0.1), createArbitraryVertex(referenceX, referenceY,  0.1)};
			...
			v = new vector[]{createArbitraryVertex(referenceX+0.065, referenceY,  0.18), createArbitraryVertex(referenceX+0.07, referenceY,  0.18), createArbitraryVertex(referenceX+0.07, referenceY,  0.1), createArbitraryVertex(referenceX+0.065, referenceY,  0.1)};
			polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.2f,1f,1));
			cargos[i][11] = polygons[polyIndex];
			
			v = new vector[]{createArbitraryVertex(referenceX+0.01, referenceY-0.01,  0.18), createArbitraryVertex(referenceX + 0.07, referenceY-0.01,  0.18), createArbitraryVertex(referenceX + 0.07, referenceY-0.01,  0.1), createArbitraryVertex(referenceX+0.01, referenceY-0.01,  0.1)};
		...
		v = new vector[]{createArbitraryVertex(-0.345, 0.3, 0.225), createArbitraryVertex(-0.14, 0.3, 0.225), createArbitraryVertex(-0.14, 0.3, -0.03), createArbitraryVertex(-0.345, 0.3, -0.03) };
		polyIndex = addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.38, 0.3, 0.26), createArbitraryVertex(0.38, 0.3, 0.26), createArbitraryVertex(-0.38, 0.3, -0.26), MainThread.textures[30], 1,1,1));
		polygons[polyIndex].shadowBias = 5000;
		...
		float h = 0.315f;
		float h2 = 0.29f;
		v = new vector[]{createArbitraryVertex(-0.34, h, -0.03), createArbitraryVertex(-0.13f, h, -0.03), createArbitraryVertex(-0.13, h, -0.05), createArbitraryVertex(-0.34, h, -0.05)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 4,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34, h, -0.2), createArbitraryVertex(-0.13f, h, -0.2), createArbitraryVertex(-0.13, h, -0.22), createArbitraryVertex(-0.34, h, -0.22)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 4,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.13, h, -0.05), createArbitraryVertex(-0.13, h, -0.2), createArbitraryVertex(-0.15, h, -0.2), createArbitraryVertex(-0.15, h, -0.05)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 3,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.32, h, -0.05), createArbitraryVertex(-0.32, h, -0.2), createArbitraryVertex(-0.34, h, -0.2), createArbitraryVertex(-0.34, h, -0.05)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 3,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34, h, -0.03), createArbitraryVertex(-0.34, h, -0.22), createArbitraryVertex(-0.34, h2, -0.22), createArbitraryVertex(-0.34, h2, -0.03)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34, h, -0.05), createArbitraryVertex(-0.34, h, -0.2), createArbitraryVertex(-0.34, h2, -0.05), stripeTExture, 3f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.32, h2, -0.03), createArbitraryVertex(-0.32, h2, -0.22), createArbitraryVertex(-0.32, h, -0.22), createArbitraryVertex(-0.32, h, -0.03)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.32, h, -0.2), createArbitraryVertex(-0.32, h, -0.05), createArbitraryVertex(-0.32, h2, -0.25), stripeTExture, 3f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.15, h, -0.03), createArbitraryVertex(-0.15, h, -0.22), createArbitraryVertex(-0.15, h2, -0.22), createArbitraryVertex(-0.15, h2, -0.03)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.15, h, -0.05), createArbitraryVertex(-0.15, h, -0.2), createArbitraryVertex(-0.15, h2, -0.05), stripeTExture, 3f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.13, h2, -0.03), createArbitraryVertex(-0.13, h2, -0.22), createArbitraryVertex(-0.13, h, -0.22), createArbitraryVertex(-0.13, h, -0.03)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.13, h, -0.2), createArbitraryVertex(-0.13, h, -0.05), createArbitraryVertex(-0.13, h2, -0.2), stripeTExture, 3f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34, h, -0.05), createArbitraryVertex(-0.13, h, -0.05), createArbitraryVertex(-0.13, h2, -0.05), createArbitraryVertex(-0.34, h2, -0.05)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 4,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34, h, -0.22), createArbitraryVertex(-0.13, h, -0.22), createArbitraryVertex(-0.13, h2, -0.22), createArbitraryVertex(-0.34, h2, -0.22)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 4,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34, h2, -0.03), createArbitraryVertex(-0.13, h2, -0.03), createArbitraryVertex(-0.13, h, -0.03), createArbitraryVertex(-0.34, h, -0.03)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 4,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34, h2, -0.2), createArbitraryVertex(-0.13, h2, -0.2), createArbitraryVertex(-0.13, h, -0.2), createArbitraryVertex(-0.34, h, -0.2)};
		polyIndex = addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), stripeTExture, 4,0.5f,1));
		
		
		v = new vector[]{createArbitraryVertex(-0.32, 0.3, -0.05), createArbitraryVertex(-0.235, 0.3, -0.05), createArbitraryVertex(-0.235, 0.3, -0.2),  createArbitraryVertex(-0.32, 0.3, -0.2)};
		...
		v = new vector[]{createArbitraryVertex(-0.235, 0.3, -0.05), createArbitraryVertex(-0.15, 0.3, -0.05), createArbitraryVertex(-0.15, 0.3, -0.2),  createArbitraryVertex(-0.235, 0.3, -0.2)};
		...
		v = new vector[]{createArbitraryVertex(-0.34, 0.27, -0.01), createArbitraryVertex(-0.13, 0.27, -0.01), createArbitraryVertex(-0.13, 0.27, -0.24),  createArbitraryVertex(-0.34, 0.27, -0.24)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[34], 1,1f,3));
		
		v = new vector[]{createArbitraryVertex(-0.34,0.3,0.08), createArbitraryVertex(-0.34,0.3,0.2), createArbitraryVertex(-0.2,0.4,0.2),  createArbitraryVertex(-0.2,0.4,0.08)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34,0.3,0.08), createArbitraryVertex(-0.2,0.4,0.08), createArbitraryVertex(-0.2,0.3,0.08)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.08), createArbitraryVertex(-0.2,0.4,0.08), createArbitraryVertex(-0.34,0.3,0.08), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.2,0.3,0.2), createArbitraryVertex(-0.2,0.4,0.2), createArbitraryVertex(-0.34,0.3,0.2)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.2), createArbitraryVertex(-0.2,0.4,0.2), createArbitraryVertex(-0.34,0.3,0.2), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.34,0.3,0.19), createArbitraryVertex(-0.2,0.4,0.19), createArbitraryVertex(-0.2,0.3,0.19)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.19), createArbitraryVertex(-0.2,0.4,0.19), createArbitraryVertex(-0.34,0.3,0.19), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.2,0.3,0.09), createArbitraryVertex(-0.2,0.4,0.09), createArbitraryVertex(-0.34,0.3,0.09)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.09), createArbitraryVertex(-0.2,0.4,0.09), createArbitraryVertex(-0.34,0.3,0.09), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.2,0.4,0.08), createArbitraryVertex(-0.2,0.4,0.09), createArbitraryVertex(-0.2,0.3,0.09), createArbitraryVertex(-0.2,0.3,0.08)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.2,0.4,0.19), createArbitraryVertex(-0.2,0.4,0.2), createArbitraryVertex(-0.2,0.3,0.2), createArbitraryVertex(-0.2,0.3,0.19)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(-0.2,0.4,0.08), createArbitraryVertex(-0.2,0.4,0.2), createArbitraryVertex(-0.2,0.39,0.2), createArbitraryVertex(-0.2,0.39,0.08)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.5f,0.1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.22, 0.35, 0.09), createArbitraryVertex(0.23, 0.6, 0.09), createArbitraryVertex(0.23, 0.58, 0.09), createArbitraryVertex(-0.22, 0.33, 0.09)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.09), createArbitraryVertex(-0.2,0.4,0.09), createArbitraryVertex(-0.34,0.3,0.09), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.22, 0.33, 0.1), createArbitraryVertex(0.23, 0.58, 0.1), createArbitraryVertex(0.23, 0.6, 0.1), createArbitraryVertex(-0.22, 0.35, 0.1)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.1), createArbitraryVertex(-0.2,0.4,0.1), createArbitraryVertex(-0.34,0.3,0.1), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.22, 0.35, 0.09), createArbitraryVertex(-0.22, 0.35, 0.1), createArbitraryVertex(0.23, 0.6, 0.1), createArbitraryVertex(0.23, 0.6, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.22, 0.35, 0.18), createArbitraryVertex(0.23, 0.6, 0.18), createArbitraryVertex(0.23, 0.58, 0.18), createArbitraryVertex(-0.22, 0.33, 0.18)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.18), createArbitraryVertex(-0.2,0.4,0.18), createArbitraryVertex(-0.34,0.3,0.18), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.22, 0.33, 0.19), createArbitraryVertex(0.23, 0.58, 0.19), createArbitraryVertex(0.23, 0.6, 0.19), createArbitraryVertex(-0.22, 0.35, 0.19)};
		addPolygon(polygons, new polygon3D(v, createArbitraryVertex(-0.34,0.4,0.19), createArbitraryVertex(-0.2,0.4,0.19), createArbitraryVertex(-0.34,0.3,0.19), MainThread.textures[35], 0.5f,0.3f,1));
		
		v = new vector[]{createArbitraryVertex(-0.22, 0.35, 0.18), createArbitraryVertex(-0.22, 0.35, 0.19), createArbitraryVertex(0.23, 0.6, 0.19), createArbitraryVertex(0.23, 0.6, 0.18)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.65, 0.05), createArbitraryVertex(0.35, 0.75, 0.05), createArbitraryVertex(0.35, 0.3, 0.05), createArbitraryVertex(0.16, 0.3, 0.05)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), createArbitraryVertex(0.35, 0.65, 0.05), v[3].myClone(), MainThread.textures[36], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.3, 0.23), createArbitraryVertex(0.35, 0.3, 0.23), createArbitraryVertex(0.35, 0.75, 0.23), createArbitraryVertex(0.16, 0.65, 0.23)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), createArbitraryVertex(0.35, 0.65, 0.23), v[3].myClone(), MainThread.textures[36], 1f,2f,1));
		
		v = new vector[]{createArbitraryVertex(0.35, 0.75, 0.05), createArbitraryVertex(0.35, 0.75, 0.23),  createArbitraryVertex(0.35, 0.3, 0.23), createArbitraryVertex(0.35, 0.3, 0.05)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), createArbitraryVertex(0.35, 0.65, 0.23), v[3].myClone(), MainThread.textures[36], 1f,2f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.5, 0.23), createArbitraryVertex(0.16, 0.5, 0.05), createArbitraryVertex(0.16, 0.3, 0.05), createArbitraryVertex(0.16, 0.3, 0.23)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.5, 0.05), createArbitraryVertex(0.16, 0.5, 0.23), createArbitraryVertex(0.34, 0.6, 0.23), createArbitraryVertex(0.34, 0.6, 0.05)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.65, 0.23), createArbitraryVertex(0.16, 0.65, 0.05), createArbitraryVertex(0.16, 0.6, 0.05), createArbitraryVertex(0.16, 0.6, 0.23)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 1f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.6, 0.23), createArbitraryVertex(0.16, 0.6, 0.19), createArbitraryVertex(0.16, 0.5, 0.19), createArbitraryVertex(0.16, 0.5, 0.23)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.6, 0.09), createArbitraryVertex(0.16, 0.6, 0.05), createArbitraryVertex(0.16, 0.5, 0.05), createArbitraryVertex(0.16, 0.5, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.65, 0.19), createArbitraryVertex(0.35, 0.75, 0.19), createArbitraryVertex(0.35, 0.3, 0.19), createArbitraryVertex(0.16, 0.3, 0.19)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), createArbitraryVertex(0.35, 0.65, 0.19), v[3].myClone(), MainThread.textures[36], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.16, 0.3, 0.09), createArbitraryVertex(0.35, 0.3, 0.09), createArbitraryVertex(0.35, 0.75, 0.09), createArbitraryVertex(0.16, 0.65, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), createArbitraryVertex(0.35, 0.65, 0.09), v[3].myClone(), MainThread.textures[36], 1f,2f,1));
		
		v = new vector[]{createArbitraryVertex(0.15, 0.66, 0.24), createArbitraryVertex(0.36, 0.76, 0.24), createArbitraryVertex(0.36, 0.76, 0.04), createArbitraryVertex(0.15, 0.66, 0.04)};
		addPolygon(polygons, new polygon3D(v, v[1].myClone(), v[2].myClone(), v[0].myClone(), MainThread.textures[37], 1f,2f,1));
		
		v = new vector[]{createArbitraryVertex(0.15, 0.66, 0.04), createArbitraryVertex(0.36, 0.76, 0.04), createArbitraryVertex(0.36, 0.75, 0.04), createArbitraryVertex(0.15, 0.65, 0.04)};
		addPolygon(polygons, new polygon3D(v, v[1].myClone(), v[2].myClone(), v[0].myClone(), MainThread.textures[37], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.15, 0.65, 0.24), createArbitraryVertex(0.36, 0.75, 0.24), createArbitraryVertex(0.36, 0.76, 0.24), createArbitraryVertex(0.15, 0.66, 0.24)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.36, 0.76, 0.04), createArbitraryVertex(0.36, 0.76, 0.24), createArbitraryVertex(0.36, 0.75, 0.24), createArbitraryVertex(0.36, 0.75, 0.04)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.15, 0.66, 0.24), createArbitraryVertex(0.15, 0.66, 0.04), createArbitraryVertex(0.15, 0.65, 0.04), createArbitraryVertex(0.15, 0.65, 0.24)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.18, 0.58, 0.05), createArbitraryVertex(0.33, 0.58, 0.05), createArbitraryVertex(0.33, 0.5, -0.15), createArbitraryVertex(0.18, 0.5, -0.15)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 0.8f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.18, 0.5, -0.15), createArbitraryVertex(0.33, 0.5, -0.15), createArbitraryVertex(0.33, 0.49, -0.15), createArbitraryVertex(0.18, 0.49, -0.15)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.33, 0.5, -0.15), createArbitraryVertex(0.33, 0.58, 0.05), createArbitraryVertex(0.33, 0.57, 0.05), createArbitraryVertex(0.33, 0.49, -0.15)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.18, 0.49, -0.15), createArbitraryVertex(0.18, 0.57, 0.05), createArbitraryVertex(0.18, 0.58, 0.05), createArbitraryVertex(0.18, 0.5, -0.15)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.19, 0.5, -0.14), createArbitraryVertex(0.32, 0.5, -0.14), createArbitraryVertex(0.32, 0.43, -0.14), createArbitraryVertex(0.19, 0.43, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[37], 1f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(0.32, 0.5, -0.14), createArbitraryVertex(0.32, 0.58, 0.05), createArbitraryVertex(0.32, 0.43, 0.05), createArbitraryVertex(0.32, 0.43, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), createArbitraryVertex(0.32, 0.5, 0.05), v[3].myClone(), MainThread.textures[36], 1f,0.5f,1));
		
		v = new vector[]{createArbitraryVertex(0.19, 0.43, -0.14), createArbitraryVertex(0.19, 0.43, 0.05), createArbitraryVertex(0.19, 0.58, 0.05), createArbitraryVertex(0.19, 0.5, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), createArbitraryVertex(0.19, 0.5, 0.05), v[3].myClone(), MainThread.textures[36], 1f,0.5f,1));
		
		
		v = new vector[]{createArbitraryVertex(0.3, 0.43, -0.14), createArbitraryVertex(0.32, 0.43, -0.14), createArbitraryVertex(0.32, 0.3, -0.14), createArbitraryVertex(0.3, 0.3, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.3, 0.3, -0.12), createArbitraryVertex(0.32, 0.3, -0.12), createArbitraryVertex(0.32, 0.43, -0.12) , createArbitraryVertex(0.3, 0.43, -0.12)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.32, 0.43, -0.14), createArbitraryVertex(0.32, 0.43, -0.12), createArbitraryVertex(0.32, 0.3, -0.12), createArbitraryVertex(0.32, 0.3, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.3, 0.3, -0.14), createArbitraryVertex(0.3, 0.3, -0.12), createArbitraryVertex(0.3, 0.43, -0.12), createArbitraryVertex(0.3, 0.43, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		
		
		v = new vector[]{createArbitraryVertex(0.19, 0.43, -0.14), createArbitraryVertex(0.21, 0.43, -0.14), createArbitraryVertex(0.21, 0.3, -0.14), createArbitraryVertex(0.19, 0.3, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.19, 0.3, -0.12), createArbitraryVertex(0.21, 0.3, -0.12), createArbitraryVertex(0.21, 0.43, -0.12) , createArbitraryVertex(0.19, 0.43, -0.12)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.21, 0.43, -0.14), createArbitraryVertex(0.21, 0.43, -0.12), createArbitraryVertex(0.21, 0.3, -0.12), createArbitraryVertex(0.21, 0.3, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		
		v = new vector[]{createArbitraryVertex(0.19, 0.3, -0.14), createArbitraryVertex(0.19, 0.3, -0.12), createArbitraryVertex(0.19, 0.43, -0.12), createArbitraryVertex(0.19, 0.43, -0.14)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[36], 0.2f,1f,1));
		...
		for(int i = 0; i < 16; i++){
			v = new vector[]{createArbitraryVertex(r*Math.cos(i*delta), 0.42, r*Math.sin(i*delta)),
							 createArbitraryVertex(r*Math.cos((i+1)*delta), 0.42, r*Math.sin((i+1)*delta)),
							 createArbitraryVertex(r*Math.cos((i+1)*delta), 0.2,  r*Math.sin((i+1)*delta)),
							 createArbitraryVertex(r*Math.cos(i*delta), 0.2, r*Math.sin(i*delta))
							};
		    ...
		    changeVertex3DGeometry(0,0.42f,0, tempVector);
		...
		for(int i = 0; i < 16; i++){
			v = new vector[]{
					 createArbitraryVertex(r*Math.cos(i*delta), 0.42, r*Math.sin(i*delta)),
					 createArbitraryVertex(r*Math.cos((i+1)*delta), 0.42,  r*Math.sin((i+1)*delta)),
					 createArbitraryVertex(r2*Math.cos((i+1)*delta), 0.42, r2*Math.sin((i+1)*delta)),
					 createArbitraryVertex(r2*Math.cos(i*delta), 0.42, r2*Math.sin(i*delta))
					};
		...
		v = new vector[]{createArbitraryVertex(-0.095, 0.42, 0.09), createArbitraryVertex(-0.08, 0.42, 0.09), createArbitraryVertex(-0.08, 0.3, 0.09), createArbitraryVertex(-0.095, 0.3, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.1), createArbitraryVertex(-0.08, 0.3, 0.1), createArbitraryVertex(-0.08, 0.42, 0.1), createArbitraryVertex(-0.095, 0.42, 0.1)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.08, 0.42, 0.09), createArbitraryVertex(-0.08, 0.42, 0.1), createArbitraryVertex(-0.08, 0.3, 0.1), createArbitraryVertex(-0.08, 0.3, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.09), createArbitraryVertex(-0.095, 0.3, 0.1), createArbitraryVertex(-0.095, 0.42, 0.1), createArbitraryVertex(-0.095, 0.42, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.42, 0.18), createArbitraryVertex(-0.08, 0.42, 0.18), createArbitraryVertex(-0.08, 0.3, 0.18), createArbitraryVertex(-0.095, 0.3, 0.18)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.19), createArbitraryVertex(-0.08, 0.3, 0.19), createArbitraryVertex(-0.08, 0.42, 0.19), createArbitraryVertex(-0.095, 0.42, 0.19)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.08, 0.42, 0.18), createArbitraryVertex(-0.08, 0.42, 0.19), createArbitraryVertex(-0.08, 0.3, 0.19), createArbitraryVertex(-0.08, 0.3, 0.18)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.18), createArbitraryVertex(-0.095, 0.3, 0.19), createArbitraryVertex(-0.095, 0.42, 0.19), createArbitraryVertex(-0.095, 0.42, 0.18)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		start.add(0,-0.01f,0);
		v = new vector[]{createArbitraryVertex(-0.08, 0.365, 0.1), createArbitraryVertex(-0.08, 0.365, 0.18), createArbitraryVertex(-0.08, 0.35, 0.18), createArbitraryVertex(-0.08, 0.35, 0.1)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1f,0.1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.35, 0.1), createArbitraryVertex(-0.095, 0.35, 0.18), createArbitraryVertex(-0.095, 0.365, 0.18), createArbitraryVertex(-0.095, 0.365, 0.1)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1f,0.1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.365, 0.1), createArbitraryVertex(-0.095, 0.365, 0.18), createArbitraryVertex(-0.08, 0.365, 0.18), createArbitraryVertex(-0.08, 0.365, 0.1)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1f,0.1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.08, 0.35, 0.1), createArbitraryVertex(-0.08, 0.35, 0.18), createArbitraryVertex(-0.095, 0.35, 0.18), createArbitraryVertex(-0.095, 0.35, 0.1)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 1f,0.1f,1));
		start.add(0,0.01f,0);
		
		start.add(0.13f,0,0);
		v = new vector[]{createArbitraryVertex(-0.095, 0.48, 0.09), createArbitraryVertex(-0.08, 0.48, 0.09), createArbitraryVertex(-0.08, 0.3, 0.09), createArbitraryVertex(-0.095, 0.3, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.1), createArbitraryVertex(-0.08, 0.3, 0.1), createArbitraryVertex(-0.08, 0.48, 0.1), createArbitraryVertex(-0.095, 0.48, 0.1)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.08, 0.48, 0.09), createArbitraryVertex(-0.08, 0.48, 0.1), createArbitraryVertex(-0.08, 0.3, 0.1), createArbitraryVertex(-0.08, 0.3, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.09), createArbitraryVertex(-0.095, 0.3, 0.1), createArbitraryVertex(-0.095, 0.48, 0.1), createArbitraryVertex(-0.095, 0.48, 0.09)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.48, 0.18), createArbitraryVertex(-0.08, 0.48, 0.18), createArbitraryVertex(-0.08, 0.3, 0.18), createArbitraryVertex(-0.095, 0.3, 0.18)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.19), createArbitraryVertex(-0.08, 0.3, 0.19), createArbitraryVertex(-0.08, 0.48, 0.19), createArbitraryVertex(-0.095, 0.48, 0.19)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.08, 0.48, 0.18), createArbitraryVertex(-0.08, 0.48, 0.19), createArbitraryVertex(-0.08, 0.3, 0.19), createArbitraryVertex(-0.08, 0.3, 0.18)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
		
		v = new vector[]{createArbitraryVertex(-0.095, 0.3, 0.18), createArbitraryVertex(-0.095, 0.3, 0.19), createArbitraryVertex(-0.095, 0.48, 0.19), createArbitraryVertex(-0.095, 0.48, 0.18)};
		addPolygon(polygons, new polygon3D(v, v[0].myClone(), v[1].myClone(), v[3].myClone(), MainThread.textures[35], 0.1f,1f,1));
	...
	public void update(){
		...
		if(currentHP <= 0){
			...
			if(countDownToDeath == 0){
				...
				if(teamNo == 0)
					MainThread.playerCommander.theBaseInfo.numberOfRefinery--;
				else
					MainThread.enemyCommander.theBaseInfo.numberOfRefinery--;
